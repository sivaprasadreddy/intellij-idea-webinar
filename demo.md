...
- **Powerful Spring Boot support** (8 mins)
  - Structure tool window
  - Spring Component Creation Wizard
...
- **Spring Data Reverse Engineering** (8 mins)
  ...
  - Generate Flyway/Liquibase database migrations from JPA/JDBC entities
  - Synchronize DB and entity changes

- **Advanced debugging using Spring Debugger** (15 mins)
...
- **Database tools support** (3 mins)
  - Generate schema diagrams
  - Explain plan
  - Autocompletion in Java code

- **Integrated Docker and Kubernetes support** (10 mins)
